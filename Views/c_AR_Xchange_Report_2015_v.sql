...
, RIGHT(w.pyr_cd, 1)                            AS [Primary_Financial_Class]
-- Patient Information ------------------------------------------------
...
, ''						AS [Patient_Middle_Name_or_Initial] -- not needed
...
, ''                                            AS [Insurance_1_Insurance_enial_Posted_Date] -- not needed
...
, ''                                            AS [Insurance_2_Insurance_enial_Posted_Date] -- not needed
-- Total --------------------------------------------------------------
