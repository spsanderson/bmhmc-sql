...
SELECT
	CASE
		WHEN SO.svc_desc LIKE 'CBC WITH WBC DIFF%' THEN 'WBC ORDER'
		WHEN SO.svc_desc LIKE 'LACTIC ACID' THEN 'LACTATE ORDER'
		WHEN SO.svc_desc LIKE '%XRAY%' THEN 'XRAY ORDER'
