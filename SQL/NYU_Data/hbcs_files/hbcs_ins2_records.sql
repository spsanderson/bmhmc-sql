...
Purpose/Description
	Gather the INS2 records for HBCS on the self pay accounts
...
INNER JOIN smsdss.pyr_dim_v AS PDV ON PAV.Pyr2_Co_Plan_Cd = PDV.src_pyr_cd
...
LEFT JOIN smsdss.c_ins_user_fields_v AS INS ON PAV.PT_NO = INS.pt_id
	...
	AND PAV.Pyr2_Co_Plan_Cd = INS.pyr_cd
