...
Purpose/Description
	Gather the INS4 records for HBCS on the self pay accounts
...
INNER JOIN smsdss.pyr_dim_v AS PDV ON PAV.Pyr4_Co_Plan_Cd = PDV.src_pyr_cd
...
LEFT JOIN smsdss.c_ins_user_fields_v AS INS ON PAV.PT_NO = INS.pt_id
	...
	AND PAV.Pyr4_Co_Plan_Cd = INS.pyr_cd
...
LEFT JOIN smsmir.pyr_plan AS PYRPLAN ON PAV.PT_NO = PYRPLAN.PT_ID
	...
	AND PAV.Pyr4_Co_Plan_Cd = PYRPLAN.pyr_cd