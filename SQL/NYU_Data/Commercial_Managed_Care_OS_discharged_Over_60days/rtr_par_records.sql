...
Purpose/Description
	Gather the PAR records for RTR on the self pay accounts

Revision History:
Date		Version		Description
----		----		----
2022-10-21	v1			Initial Creation
2023-02-03	v2			Corrections due to call
***********************************************************************
*/
...
SELECT [RECORD_IDENTIFIER] = 'PAR',
	...
	[TRANSACTION_CODE_TYPE] = CASE
		...
		WHEN LEFT(PAY.PAY_CD, 4) = '0097'
			THEN '3'
		WHEN LEFT(PAY.PAY_CD, 3) = '098'
			THEN '3'
		WHEN LEFT(PAY.PAY_CD, 4) = '0098'
			THEN '3'
		WHEN LEFT(PAY.PAY_CD, 3) = '099'
			THEN '6'
		WHEN LEFT(PAY.PAY_CD, 4) = '0099'
			THEN '6'
		WHEN LEFT(PAY.PAY_CD, 3) = '096'
			THEN '6'
		ELSE '999'
		END,
