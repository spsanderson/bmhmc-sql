...
Tables/Views:
    ...
    smsmir.dx_grp
    smsmir.sproc
    smsdss.c_nyu_unswr_condition_accounts_tbl
    smsdss.pract_dim_v
    SMSDSS.pyr_dim_v
...
2022-08-02	v2			Added admit source
2022-08-18	v3			Drop period from dx and px codes
						Fix diabetes and chf to look for principal dx
***********************************************************************
*/
...
FROM smsdss.c_nyu_usnwr_condition_accounts_tbl AS BASE_POP
