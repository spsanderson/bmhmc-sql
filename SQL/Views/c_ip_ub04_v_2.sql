...
CREATE VIEW [smsdss].[c_ip_ub04_v_2] AS
...
FROM smsdss.actv_v as a 
LEFT JOIN smsdss.vst_v as b
ON a.vst_key = b.vst_key 
	and a.src_sys_id = b.src_sys_id
LEFT JOIN smsdss.acct_v as d
ON a.pt_id = d.pt_id 
	AND a.pt_key=d.pt_key

WHERE B.vst_type_cd IN ('I', 'O')
AND a.chg_tot_amt <> 0
