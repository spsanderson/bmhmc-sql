...
SELECT *
, CASE
	WHEN UNICODE(SUBSTRING(Value, 1, 1)) = 13 THEN CAST('0' AS float)
	WHEN UNICODE(SUBSTRING(Value, 2, 1)) = 13 THEN CAST('0' AS float)
	WHEN UNICODE(SUBSTRING(VALUE, 3, 1)) = 13 THEN CAST(RTRIM(LTRIM(SUBSTRING(VALUE, 1, 2))) AS float)
	WHEN UNICODE(SUBSTRING(VALUE, 4, 1)) = 13 THEN CAST(RTRIM(LTRIM(SUBSTRING(VALUE, 1, 3))) AS float)
	WHEN UNICODE(SUBSTRING(VALUE, 5, 1)) = 13 THEN CAST(RTRIM(LTRIM(SUBSTRING(VALUE, 1, 4))) AS float)
	WHEN UNICODE(SUBSTRING(VALUE, 6, 1)) = 13 THEN CAST(RTRIM(LTRIM(SUBSTRING(VALUE, 1, 5))) AS float)
	ELSE Value
  END AS NEW_VAL
