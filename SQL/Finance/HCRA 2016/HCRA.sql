...
, A.[Admit Date]
, A.[Discharge Date]
, A.[PRIMARY PAYOR] + ',' + COALESCE(B.INS_NAME, A.[Primary Ins Name]) AS [Payor Code]
, A.[Primary Ins Name]         AS [Payor Description]
, A.[primary payor] + ',' + ISNULL(B.INS_NAME, '') + ',' + 
  A.[PRIMARY INS NAME] + ',' + A.[subscr_ins_grp_name]  AS [Pyor Sub-Code]
, '' AS [Payor ID]
, '' AS [Payor TIN]
, A.[Primary Payor]
...
--DROP TABLE #deductible_payment_a, #deductible_payment_b, #COINS_CHARGE_A, #COINS_PAY_A;
