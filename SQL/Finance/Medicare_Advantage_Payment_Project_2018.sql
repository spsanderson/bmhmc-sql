...
LEFT OUTER JOIN (
	...
	from smsmir.pay
	where pay_cd in (
		'0030506','00330704','03300605'
	)
	group by pt_id, from_file_ind
) AS PT_Resp
ON A.Pt_No = PT_Resp.pt_id
	AND A.from_file_ind = PT_Resp.from_file_ind
LEFT OUTER JOIN smsmir.vst_rpt AS VST_RPT
ON A.Pt_No = VST_RPT.pt_id
...
AND A.Pyr1_Co_Plan_Cd IN (
	'E18','E28','E08','E12','E27','E19','E13','E29'
)
GO
;
