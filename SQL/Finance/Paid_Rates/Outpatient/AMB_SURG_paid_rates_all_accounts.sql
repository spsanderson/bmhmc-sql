/*
***********************************************************************
File: AMB_SURG_paid_rates_all_accounts.sql
...
WHERE PTPG.PT_TYPE IN ('D','G')
	AND VST.prim_pyr_cd NOT IN ('B75','B76')
GROUP BY PTPG.pyr_group,
	PTPG.PYR_GROUP_DESC
ORDER BY PTPG.pyr_group
