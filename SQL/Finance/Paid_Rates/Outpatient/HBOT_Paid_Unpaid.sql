...
Purpose/Description
	Gets counts for all HBOT accounts and total payments by FC paid
	in full and not.
...
LEFT OUTER JOIN #RECORDS AS REC ON PG.PYR_GROUP = REC.user_pyr1_cat
