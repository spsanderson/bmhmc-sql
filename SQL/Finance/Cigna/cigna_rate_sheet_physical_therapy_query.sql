/*
***********************************************************************
File: cigna_rate_sheet_physical_therapy_query.sql
...
Purpose/Description
	Get Other Physical Therapy Volume
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE rev_cd IN ('420','421','422','423','424','429')
				)
		) AS [Physical_Therapy_Qty],
	(
