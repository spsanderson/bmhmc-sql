/*
***********************************************************************
File: cigna_rate_sheet_oncology_treatment_query.sql
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE rev_cd IN ('280','289')
				)
		) AS [Oncology_Treatment_Qty],
	(
