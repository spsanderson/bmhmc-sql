/*
***********************************************************************
File: cigna_rate_sheet_respiratory_therapy_query.sql
...
Purpose/Description
	Get Respiratory Therapy Volume
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE rev_cd IN ('410','412','419')
				)
		) AS [Respiratory_Therapy_Qty],
	(
