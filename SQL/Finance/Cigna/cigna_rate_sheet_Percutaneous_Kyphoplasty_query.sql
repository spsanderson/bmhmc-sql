/*
***********************************************************************
File: cigna_rate_sheet_Percutaneous_Kyphoplasty_query.sql
...
Purpose/Description
	Get Percutaneous Kyphoplasty Volume
...
WHERE PAV.Dsch_Date >= @STARTDATE
	...
	AND PAV.PT_NO IN (
		...
		WHERE (
			ClasfCd BETWEEN '22523' AND '22525' OR
			ClasfCd BETWEEN '22513' AND '22515'
		)
	)
