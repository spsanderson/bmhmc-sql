/*
***********************************************************************
File: cigna_rate_sheet_brachytherapy_query.sql
...
WHERE PAV.Dsch_Date >= @STARTDATE
	...
	AND PAV.PT_NO IN (
			...
			WHERE ClasfCd IN (
				'0182T','77750','77789','77799'
			)
			OR ClasfCd BETWEEN '77326' AND '77328'
			OR ClasfCd BETWEEN '77761' AND '77763'
			OR ClasfCd BETWEEN '77776' AND '77778'
			OR ClasfCd BETWEEN '77787' AND '77787'
		)
	AND PT_NO IN (
