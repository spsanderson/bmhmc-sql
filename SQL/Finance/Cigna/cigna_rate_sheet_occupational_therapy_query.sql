/*
***********************************************************************
File: cigna_rate_sheet_occupational_therapy_query.sql
...
Purpose/Description
	Get Occupational Therapy Volume
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE rev_cd IN ('430','431','432','433','434','439')
				)
		) AS [Occupational_Therapy_Qty],
	(
