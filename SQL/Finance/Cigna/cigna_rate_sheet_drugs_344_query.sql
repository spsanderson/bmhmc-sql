/*
***********************************************************************
File: cigna_rate_sheet_drugs_344_query.sql
...
Purpose/Description
	Get Volume Therapeutic RadioPharm - RC 344
...
SELECT PAV.med_rec_no,
	...
	(
		...
		) AS [Drugs_Theraputic_RadioPharm_Qty],
	(
		...
		) AS [Drugs_Theraputic_RadioPharm_Chgs]
