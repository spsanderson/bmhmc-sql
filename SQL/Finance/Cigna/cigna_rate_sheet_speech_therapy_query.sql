/*
***********************************************************************
File: cigna_rate_sheet_speech_therapy_query.sql
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE rev_cd IN ('440','441','442','443','444','449')
				)
		) AS [Speech_Therapy_Qty],
	(
