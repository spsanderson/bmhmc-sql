/*
***********************************************************************
File: cigna_rate_sheet_op_labratory_pathology_query.sql
...
Purpose/Description
	Get OP Laboratory Pathology Volume
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE rev_cd IN ('300','301','302','303','304','305','306','307','309','310','311','312','314')
				)
		) AS [Lab_Pathology_Qty],
	(
