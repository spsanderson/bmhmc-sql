/*
***********************************************************************
File: cigna_rate_sheet_nuclear_medicine_query.sql
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE rev_cd IN ('340','341','342','349')
				)
		) AS [Nuclear_Medicine_Qty],
	(
