/*
***********************************************************************
File: cigna_rate_sheet_other_diagnostic_radiology_query.sql
...
Purpose/Description
	Get Other Diagnostic Radiology Volume
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE rev_cd IN ('320','321','322','323','324','329')
				)
		) AS [Other_Dx_Rad_Qty],
	(
