/*
***********************************************************************
File: cigna_rate_sheet_hemodialysis_query.sql
...
Purpose/Description
	Get Hemodialysis Volume

Revision History:
Date		Version		Description
----		----		----
2019-07-02	v1			Initial Creation
***********************************************************************
*/
	...
	(
		...
		WHERE PAV.Pt_No = ZZZ.pt_id
			...
			AND actv_cd IN (
				...
				WHERE (
					rev_cd BETWEEN '820' AND '825'
					OR rev_cd = '829'
					OR rev_cd BETWEEN '830' AND '835'
					OR rev_cd BETWEEN '839' AND '845'
					OR rev_cd BETWEEN '849' AND '855'
					OR rev_cd = '859'
					OR rev_cd BETWEEN '880' AND '881'
					OR rev_cd = '889'
				)
			)
		) AS [Hemodialysis_Qty],
