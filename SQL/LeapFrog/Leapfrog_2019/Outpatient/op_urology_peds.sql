...
Purpose/Description
	Pull peds urology procedures 2019 op lf
...
, PAV.Adm_Date
, pvn.ClasfCd
, 'Urology_Peds' AS 'LeapFrog_Procedure_Group'
...
CROSS APPLY (
	SELECT
		CASE
			...
			WHEN PVN.CLASFCD BETWEEN '54162' AND '54162' THEN 'Circumcision'
			WHEN PVN.CLASFCD BETWEEN '54163' AND '54163' THEN 'Circumcision'
			WHEN PVN.CLASFCD BETWEEN '52000' AND '52000' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52007' AND '52204' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52351' AND '52351' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52214' AND '52240' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52300' AND '52315' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52352' AND '52352' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52353' AND '52353' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52356' AND '52356' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52277' AND '52285' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52287' AND '52287' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '52355' AND '52355' THEN 'Cystourethroscopy'
			WHEN PVN.CLASFCD BETWEEN '54300' AND '54304' THEN 'Male Genital Procedures'
			WHEN PVN.CLASFCD BETWEEN '54322' AND '54440' THEN 'Male Genital Procedures'
			WHEN PVN.CLASFCD BETWEEN '54510' AND '54692' THEN 'Male Genital Procedures'
			WHEN PVN.CLASFCD BETWEEN '55040' AND '55060' THEN 'Male Genital Procedures'
			WHEN PVN.CLASFCD BETWEEN '55150' AND '55180' THEN 'Male Genital Procedures'
			WHEN PVN.CLASFCD BETWEEN '53000' AND '53060' THEN 'Urethra Procedures'
			WHEN PVN.CLASFCD BETWEEN '53450' AND '53665' THEN 'Urethra Procedures'
			WHEN PVN.CLASFCD BETWEEN '57287' AND '57288' THEN 'Vaginal Repair Procedures'
		END AS 'Description'
) AS CCSParent
