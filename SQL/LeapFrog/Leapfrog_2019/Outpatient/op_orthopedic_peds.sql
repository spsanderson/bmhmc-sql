...
Purpose/Description
	Pull adult/peds cases for peds ortho procedures 2019 op lf
...
, PAV.Adm_Date
, pvn.ClasfCd
, 'Orthopedic_Peds' AS 'LeapFrog_Procedure_Group'
...
ON PAV.Pt_No = PVN.Pt_No
	AND (
		PVN.ClasfCd BETWEEN '29848' AND '29848' OR 
		...
		PVN.ClasfCd BETWEEN '23120' AND '23156' OR 
		PVN.ClasfCd BETWEEN '29824' AND '29824' OR 
		...
		PVN.ClasfCd BETWEEN '29820' AND '29823' OR 
		...
		PVN.ClasfCd BETWEEN '28192' AND '28250' OR 
		...
		PVN.ClasfCd BETWEEN '20665' AND '20697' OR 
		PVN.ClasfCd BETWEEN '23480' AND '23491'
	)
...
CROSS APPLY (
	SELECT
		CASE
			WHEN PVN.CLASFCD BETWEEN '29848' AND '29848' THEN 'Decompression peripheral nerve'
			...
			WHEN PVN.CLASFCD BETWEEN '23120' AND '23156' THEN 'Partial excision bone'
			WHEN PVN.CLASFCD BETWEEN '29824' AND '29824' THEN 'Partial excision bone'
			...
			WHEN PVN.CLASFCD BETWEEN '29820' AND '29823' THEN 'Other OR therapeutic procedures on joints'
			...
			WHEN PVN.CLASFCD BETWEEN '20665' AND '20697' THEN 'Other OR therapeutic procedures on bone'
			WHEN PVN.CLASFCD BETWEEN '23480' AND '23491' THEN 'Other OR therapeutic procedures on bone'
		END AS 'Description'
) AS CCS
...
CROSS APPLY (
	SELECT
		CASE
			WHEN PVN.CLASFCD BETWEEN '29848' AND '29848' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '64702' AND '64727' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '24583' AND '24685' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25500' AND '25620' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25622' AND '25645' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25670' AND '25670' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '26600' AND '26785' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25441' AND '25449' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '24105' AND '24105' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '24301' AND '24342' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25000' AND '25031' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25109' AND '25116' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25260' AND '25318' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '26035' AND '26060' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '26113' AND '26113' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '26116' AND '26125' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '26160' AND '26180' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '26350' AND '26510' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '24343' AND '24352' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '24357' AND '24359' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25320' AND '25320' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '25800' AND '25830' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '26540' AND '26545' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '26820' AND '26863' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '29835' AND '29838' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '29844' AND '29846' THEN 'Finger, Hand, Wrist, Forearm, and Elbow Procedure '
			WHEN PVN.CLASFCD BETWEEN '23120' AND '23156' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '29824' AND '29824' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '23500' AND '23680' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '24498' AND '24582' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '25431' AND '25440' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '29825' AND '29825' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '23470' AND '23474' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '29826' AND '29826' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '23073' AND '23073' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '23405' AND '23412' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '23430' AND '23440' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '29827' AND '29828' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '29806' AND '29807' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '29820' AND '29823' THEN 'Shoulder Procedure '
			WHEN PVN.CLASFCD BETWEEN '63265' AND '63308' THEN 'Spine Procedure '
			WHEN PVN.CLASFCD BETWEEN '27125' AND '27138' THEN 'Hip Procedure '
			WHEN PVN.CLASFCD BETWEEN '29914' AND '29916' THEN 'Hip Procedure '
			WHEN PVN.CLASFCD BETWEEN '29861' AND '29868' THEN 'Hip Procedure '
			WHEN PVN.CLASFCD BETWEEN '29870' AND '29871' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '29888' AND '29889' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '29873' AND '29873' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '29884' AND '29884' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '27403' AND '27409' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '29880' AND '29883' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '27420' AND '27424' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '27427' AND '27429' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '27437' AND '27447' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '27570' AND '27580' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '29874' AND '29879' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '29885' AND '29887' THEN 'Knee Procedure '
			WHEN PVN.CLASFCD BETWEEN '27750' AND '27848' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '28320' AND '28322' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '28400' AND '28675' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '29850' AND '29856' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '27600' AND '27606' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '27650' AND '27692' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '28008' AND '28011' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '28086' AND '28092' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '28192' AND '28250' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '27695' AND '27698' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '28740' AND '28750' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '29891' AND '29892' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '29894' AND '29899' THEN 'Toe, Foot, Ankle, and Leg Procedure'
			WHEN PVN.CLASFCD BETWEEN '29815' AND '29819' THEN 'General Orthopedic Procedure'
			WHEN PVN.CLASFCD BETWEEN '29830' AND '29834' THEN 'General Orthopedic Procedure'
			WHEN PVN.CLASFCD BETWEEN '29999' AND '29999' THEN 'General Orthopedic Procedure'
			WHEN PVN.CLASFCD BETWEEN '20665' AND '20697' THEN 'General Orthopedic Procedure'
			WHEN PVN.CLASFCD BETWEEN '23480' AND '23491' THEN 'General Orthopedic Procedure'
		END AS 'Description'
) AS CCSParent
