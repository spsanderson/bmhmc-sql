...
ON PAV.Pt_No = PVN.Pt_No
	AND (
		PVN.ClasfCd BETWEEN '12001' AND '13133'
	)
...
CROSS APPLY (
	SELECT
		CASE
			WHEN PVN.CLASFCD BETWEEN '12001' AND '13133' THEN 'Suture of skin and subcutaneous tissue'
		END AS 'Description'
) AS CCS
...
CROSS APPLY (
	SELECT
		CASE
			WHEN PVN.CLASFCD BETWEEN '12001' AND '13133' THEN 'Complex Skin Repair'
		END AS 'Description'
) AS CCSParent
