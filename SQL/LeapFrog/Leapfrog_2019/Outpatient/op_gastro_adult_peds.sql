...
CROSS APPLY (
	SELECT
		CASE
			WHEN PVN.CLASFCD BETWEEN '43248' AND '43249' THEN 'Upper GI Endoscopy '
			WHEN PVN.CLASFCD BETWEEN '43234' AND '43242' THEN 'Upper GI Endoscopy '
			WHEN PVN.CLASFCD BETWEEN '43250' AND '43259' THEN 'Upper GI Endoscopy '
			WHEN PVN.CLASFCD BETWEEN '43450' AND '43460' THEN 'Other Upper GI Procedure'
			WHEN PVN.CLASFCD BETWEEN '44360' AND '44361' THEN 'Small Intestine and Stomal Endoscopy'
			WHEN PVN.CLASFCD BETWEEN '45355' AND '45378' THEN 'Lower GI Endoscopy'
			WHEN PVN.CLASFCD BETWEEN '45380' AND '45393' THEN 'Lower GI Endoscopy'
			WHEN PVN.CLASFCD BETWEEN '45308' AND '45331' THEN 'Lower GI Endoscopy'
		END AS 'Description'
) AS CCSPARENT
