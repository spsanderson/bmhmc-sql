...
CROSS APPLY (
	SELECT
		CASE
			WHEN PVN.CLASFCD BETWEEN '57510' AND '57550' THEN 'Cervix Procedure'
			WHEN PVN.CLASFCD BETWEEN '58559' AND '58561' THEN 'Hysteroscopy'
			WHEN PVN.CLASFCD BETWEEN '58563' AND '58563' THEN 'Hysteroscopy'
			WHEN PVN.CLASFCD BETWEEN '58555' AND '58558' THEN 'Hysteroscopy'
			WHEN PVN.CLASFCD BETWEEN '58661' AND '58661' THEN 'Uterus and Adnexa Laparoscopies'
			WHEN PVN.CLASFCD BETWEEN '58670' AND '58671' THEN 'Uterus and Adnexa Laparoscopies'
			WHEN PVN.CLASFCD BETWEEN '58662' AND '58662' THEN 'Uterus and Adnexa Laparoscopies'
		END AS 'Description'
) AS CCSParent
