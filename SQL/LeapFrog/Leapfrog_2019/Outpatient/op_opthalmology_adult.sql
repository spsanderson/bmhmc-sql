/*
***********************************************************************
File: op_opthalmology_adult.sql
...
Purpose/Description
	Pull adult/peds cases for adult opthalmology procedures 2019 op lf
...
, PAV.Adm_Date
, pvn.ClasfCd
, 'Opthalmology_Adult' AS 'LeapFrog_Procedure_Group'
, CCS.[Description] AS 'CCS_Description'
, CCSParent.[Description]
...
ON PAV.Pt_No = PVN.Pt_No
	AND (
		...
		PVN.ClasfCd BETWEEN '67500' AND '67560' OR 
		PVN.ClasfCd BETWEEN '67039' AND '67040' OR 
		PVN.ClasfCd BETWEEN '67101' AND '67113' OR 
		PVN.ClasfCd BETWEEN '66990' AND '67038' OR 
		PVN.ClasfCd BETWEEN '67041' AND '67043' OR 
		PVN.ClasfCd BETWEEN '67115' AND '67121'
	)
...
CROSS APPLY (
	SELECT
		CASE
			...
			WHEN PVN.CLASFCD BETWEEN '67039' AND '67040' THEN 'Repair of retinal tear, detachment'
			WHEN PVN.CLASFCD BETWEEN '67101' AND '67113' THEN 'Repair of retinal tear, detachment'
			WHEN PVN.CLASFCD BETWEEN '66990' AND '67038' THEN 'Other intraocular therapeutic procedures'
			WHEN PVN.CLASFCD BETWEEN '67041' AND '67043' THEN 'Other intraocular therapeutic procedures'
			WHEN PVN.CLASFCD BETWEEN '67115' AND '67121' THEN 'Other intraocular therapeutic procedures'
		END AS 'Description'
) AS CCS
...
CROSS APPLY (
	SELECT
		CASE
			...
			WHEN PVN.CLASFCD BETWEEN '67039' AND '67040' THEN 'Posterior Segment Eye Procedures'
			WHEN PVN.CLASFCD BETWEEN '67101' AND '67113' THEN 'Posterior Segment Eye Procedures'
			WHEN PVN.CLASFCD BETWEEN '66990' AND '67038' THEN 'Posterior Segment Eye Procedures'
			WHEN PVN.CLASFCD BETWEEN '67041' AND '67043' THEN 'Posterior Segment Eye Procedures'
			WHEN PVN.CLASFCD BETWEEN '67115' AND '67121' THEN 'Posterior Segment Eye Procedures'
		END AS 'Description'
) AS CCSParent
