...
-- ADT02
LEFT OUTER JOIN @ADT02Final_Tbl AS ADT02FINALTBL ON PVD.PatientVisitOID = ADT02FINALTBL.PatientVisit_OID
-- covid indicator text
LEFT OUTER JOIN @CovidIndTbl AS CVIND ON PVD.PatientVisitOID = CVIND.PatientVisit_OID
-- CV19DX
LEFT OUTER JOIN #CV19DX AS CV19DX ON PVD.PatientAccountID = CV19DX.PatientAccountID
-- PDOC
LEFT OUTER JOIN #PDOC AS PDOC ON PVD.PatientVisitOID = PDOC.PATIENTVISIT_OID
-- ATN DOCTOR
LEFT OUTER JOIN (
...
--		Truncate Table smsdss.c_covid_extract_tbl;

-- Create a new table called 'c_covid_extract_tbl' in schema 'smsdss'
...
(
	...
	[Adm_Dtime] DATETIME2,
	[DC_DTime] DATETIME2,
	[Nurs_Sta] VARCHAR(100),
	[Bed] VARCHAR(100),
	[In_House] INT,
	[Hosp_Svc] VARCHAR(100),
	[Pt_Accomodation] VARCHAR(500),
	[Dx_Order] VARCHAR(8000),
	[Covid_Indicator] VARCHAR(8000),
	[PatientReasonforSeekingHC] VARCHAR(8000),
	[Mortality_Flag] INT,
	[Pos_MRN] INT,
	[Pt_ADT] VARCHAR(100),
	[RESULT_CLEAN] VARCHAR(8000),
	[Distinct_Visit_Flag] INT,
	[Vented] VARCHAR(100),
	[Last_Vent_Check] DATETIME2,
	[Order_NO] VARCHAR(250),
	[Covid_Order] VARCHAR(250),
	[Order_DTime] DATETIME2,
	[Order_Status] VARCHAR(8000),
	[Order_Status_DTime] DATETIME2,
	[Result_DTime] DATETIME2,
	[Result] VARCHAR(8000),
	[DC_Disp] VARCHAR(8000),
	--[Vent_Flag],
	[Subseqent_Visit_Flag] INT,
	[Order_Flag] INT,
	[Result_Flag] INT,
	[PT_Street_Address] VARCHAR(8000),
	[PT_City] VARCHAR(5000),
	[PT_State] VARCHAR(100),
	[PT_Zip_CD] VARCHAR(100),
	--[PT_Height],
	--[PT_Weight],
	[PT_Comorbidities] VARCHAR(8000),
	[PT_Admitted_From] VARCHAR(8000),
	--,[Chol]
	--,[HDL]
	--,[LDL]
	--,[Trig]
	...
	[PT_DOB] DATETIME2,
	[State_Age_Group] VARCHAR(100),
	[first_positive_flag_dtime] DATETIME2,
	[last_negative_flag_dtime] DATETIME2,
	[pt_last_test_positive] INT,
	[Last_Positive_Result_DTime] DATETIME2,
	[B97.29] VARCHAR(100),
	[U07.1] VARCHAR(100),
	[Z03.818] VARCHAR(100),
	[Z20.828] VARCHAR(100),
	[DC_Summary_CV19_Dx] VARCHAR(8000),
	[DC_Summary_CV19_Dx_CreatedDTIME] DATETIME2,
	[Clinical_Note_CV19_Dx] VARCHAR(8000),
	[Clinical_Note_CV19_Dx_CreatedDTime] DATETIME2,
	[Attending_Provider] VARCHAR(8000)
);
GO
...
SELECT A.MRN,
	...
	--Into smsdss.c_covid_extract_tbl
FROM #TEMPA AS A
-- occupation
