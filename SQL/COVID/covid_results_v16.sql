...
2020-06-09	v21			fix the DateTime value being shows for null results
						...
						those to NULL
2020-06-11	v22			Add last negative result column
						Move columns pt_last_test_positive, Last_Positive_Result_DTime
						to the end of the extract
2020-06-12	v23			Add Dx_Order, and Covid_Indicator columns
2020-06-24	v24			Add 'B97.29', 'U07.1', 'Z20.828', 'Z03.818' as flags
						#CV19DX persistent temp table
2020-06-29	v25			Add PDCO DC Summary TextValue and Clinical Summary Note
						Add attending MD
2020-07-08	v26			Remove the following fields
						Chol
						HDL
						LDL
						Trig
