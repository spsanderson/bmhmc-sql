	...
	*/
	...
	--FLU.OrderAbbreviation AS [Flu_OrderAbbreviation],
	--FLU.OrderID AS [Flu_OrderID],
	--FLU.ResultDateTime AS [Flu_ResultDateTime],
	--CASE WHEN FLU.Flu_A LIKE '%POSITIVE%' THEN 1 ELSE 0 END Flu_A,
	--CASE WHEN FLU.Flu_B LIKE '%POSITIVE%' THEN 1 ELSE 0 END Flu_B
INTO #TEMPA
...
IF OBJECT_ID('smsdss.c_covid_extract_flu_test_tbl', 'U') IS NOT NULL
	DROP TABLE smsdss.c_covid_extract_flu_test_tbl;

-- Create the table in the specified schema
CREATE TABLE smsdss.c_covid_extract_flu_test_tbl (
	MRN INT NULL,
	PTNO_NUM INT NULL,
	...
	--[FLU_OrderAbbreviation] VARCHAR(500) NULL,
	--[FLU_OrderID] VARCHAR(500) NULL,
	--[FLU_ResultDateTime] DATETIME2 NULL,
	--[Flu_A] VARCHAR(500) NULL,
	--[Flu_B] VARCHAR(500) NULL,
	[RunDateTime] DATETIME2
	);

INSERT INTO smsdss.c_covid_extract_flu_test_tbl
...
SELECT A.MRN,
	...
	A.Positive_Flu_Flag,
	--A.Flu_OrderAbbreviation,
	--A.Flu_OrderID,
	--A.Flu_ResultDateTime,
	--A.Flu_A,
	--A.Flu_B,
