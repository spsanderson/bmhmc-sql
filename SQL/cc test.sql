...
, (CASE
    WHEN MAX(C.PRIN_DX_CD_1) + MAX(C.PRIN_DX_CD_2) + 
	MAX(C.PRIN_DX_CD_3) + MAX(C.PRIN_DX_CD_4) + MAX(C.PRIN_DX_CD_5) < 6
    THEN MAX(C.PRIN_DX_CD_1) + MAX(C.PRIN_DX_CD_2) + 
	MAX(C.PRIN_DX_CD_3) + MAX(C.PRIN_DX_CD_4) + MAX(C.PRIN_DX_CD_5)
    ELSE 6
