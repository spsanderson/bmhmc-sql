...
2022-05-13	v14			Fix History of Covid 
***********************************************************************
*/
...
INSERT INTO #skin_disorders_tbl (pt_id, skin_disorders_burns)
SELECT A.pt_id,	
	[skin_disorders_burns] = CASE
		WHEN B.Subcategory = 'Epidermolysis bullosa'
			THEN 1
		WHEN B.Subcategory = 'Burn/Corrosion of skin'
			THEN 2
		WHEN B.Subcategory = 'Frostbite'
			THEN 3
		ELSE 0
		END
FROM smsmir.dx_grp AS A
...
INSERT INTO #skin_disorders_pvt_tbl (pt_id, skin_disorders_burns)
SELECT PVT.pt_id,	
...
FROM #skin_disorders_pvt_tbl as A
	
PIVOT(MAX(skin_disorders_burns) FOR skin_disorders_burns IN ("0","1","2","3")) AS PVT
...
SELECT 	[facility_identifier] = '0885',
	...
	[skin_disorders_burns] = CASE
		WHEN SKIN.skin_disorders_burns IS NULL
			THEN '0'
		ELSE SKIN.skin_disorders_burns
		END,
	[smoking_vaping] = CASE 
	...
	[cv_outcomes_in_hospital] = CASE 
		WHEN CV_IN_HOSP.pt_id IS NULL
			THEN '0'
		ELSE CV_IN_HOSP.cv_outcomes_in_hospital
		END,
