USE [SMSPHDSSS0X0]
GO
/****** Object:  StoredProcedure [dbo].[c_covid_vents_sp]    Script Date: 7/9/2020 2:46:14 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[c_covid_vents_sp]
AS
...
BEGIN
	...
	-- Create a new table called 'c_covid_vents_tbl' in schema 'smsdss'
	-- Drop the table if it already exists
	IF OBJECT_ID('smsdss.c_covid_vents_tbl', 'U') IS NOT NULL
	DROP TABLE smsdss.c_covid_vents_tbl;
