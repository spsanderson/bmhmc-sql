...
/*
***********************************************************************
File: c_covid_external_positive_test_sp.sql

Input Parameters:
	None

Tables/Views:
	smsdss.c_covid_external_positive_test_tbl
	[SC_server].[Soarian_Clin_Prd_1].DBO.HPatientVisit

Creates Table:
	smsdss.c_covid_ext_pos_test_tbl
...
2021-02-25  v2          Write for new stream testing
***********************************************************************
*/

CREATE PROCEDURE [dbo].[c_covid_external_positive_test_sp]
AS
...
BEGIN
	...
	IF OBJECT_ID('smsdss.c_covid_ext_pos_test_tbl', 'U') IS NOT NULL
	DROP TABLE smsdss.c_covid_ext_pos_test_tbl;
	...
	*/
	...
	SELECT *
	INTO smsdss.c_covid_ext_pos_test_tbl
	FROM @ExtPos;
