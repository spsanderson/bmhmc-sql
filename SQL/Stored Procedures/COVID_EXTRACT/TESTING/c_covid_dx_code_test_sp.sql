...
/*
***********************************************************************
File: c_covid_dx_code_test_sp.sql
...
2021-02-25	v2			Make for testing of new stream
***********************************************************************
*/

CREATE PROCEDURE [dbo].[c_covid_dx_cd_test_sp]
AS
...
BEGIN
    ...
    IF OBJECT_ID('smsdss.c_covid_dx_cd_ind_test_tbl', 'U') IS NOT NULL
    DROP TABLE smsdss.c_covid_dx_cd_ind_test_tbl;
	...
	*/
	SELECT PVT.PatientAccountID,
		...
		PVT.[Z20.828],
		PVT.[Z03.818]
	INTO smsdss.c_covid_dx_cd_ind_test_tbl
	FROM (
