...
/*
***********************************************************************
File: c_covid_orders_test_sp.sql
...
***********************************************************************
*/
ALTER PROCEDURE [dbo].[c_covid_orders_test_sp]
AS
BEGIN
	SET NOCOUNT ON;
	SET ANSI_NULLS ON
	...
	IF OBJECT_ID('smsdss.c_covid_orders_test_tbl', 'U') IS NOT NULL
		DROP TABLE smsdss.c_covid_orders_test_tbl;

	IF OBJECT_ID('smsdss.c_covid_order_occ_test_tbl', 'U') IS NOT NULL
		DROP TABLE smsdss.c_covid_order_occ_test_tbl
	...
	*/
	...
	SELECT A.id_num,
		...
		A.CreationTime,
		A.ObjectID
	INTO smsdss.c_covid_orders_test_tbl
	...
	*/
	...
	SELECT A.id_num,
		...
		A.StatusEnteredDatetime,
		A.ObjectID
	INTO smsdss.c_covid_order_occ_test_tbl
