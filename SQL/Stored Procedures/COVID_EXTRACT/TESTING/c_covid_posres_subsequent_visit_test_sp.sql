...
/*
***********************************************************************
File: c_covid_posres_subsequent_visit_test_sp.sql
...
ALTER PROCEDURE [dbo].[c_covid_posres_subsequent_visit_test_sp]
AS
...
BEGIN
	...
	SET NOCOUNT ON;
	-- Create a new table called 'c_covid_posres_subsequent_visits_test_tbl' in schema 'smsdss'
	-- Drop the table if it already exists
	IF OBJECT_ID('smsdss.c_covid_posres_subsequent_visits_test_tbl', 'U') IS NOT NULL
	DROP TABLE smsdss.c_covid_posres_subsequent_visits_test_tbl;
	...
	*/
	...
	FROM smsdss.c_positive_covid_visits_test_tbl AS A
	...
	SELECT *
	INTO smsdss.c_covid_posres_subsequent_visits_test_tbl
	FROM @Subsequent;
