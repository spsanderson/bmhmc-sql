...
/*
***********************************************************************
File: c_covid_hwac_pivot_test_sp.sql
...
CREATE PROCEDURE [dbo].[c_covid_hwac_pivot_test_sp]
AS
...
BEGIN
	...
	SET NOCOUNT ON;
	-- Create a new table called 'c_covid_hwac_pivot_test_tbl' in schema 'smsdss'
	-- Drop the table if it already exists
	IF OBJECT_ID('smsdss.c_covid_hwac_pivot_test_tbl', 'U') IS NOT NULL
	DROP TABLE smsdss.c_covid_hwac_pivot_test_tbl;
	...
	*/
	...
	SELECT PVT.PatientAccountID,
		...
		PVT.perf_dtime,
		PVT.form_usage
	INTO smsdss.c_covid_hwac_pivot_test_tbl
	FROM (
