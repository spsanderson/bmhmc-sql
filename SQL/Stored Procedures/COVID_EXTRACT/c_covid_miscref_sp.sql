...
CREATE PROCEDURE [dbo].[c_covid_miscref_sp]
AS
...
BEGIN
	...
	IF OBJECT_ID('smsdss.c_covid_miscref_tbl', 'U') IS NOT NULL
	DROP TABLE smsdss.c_covid_miscref_tbl;
	...
	SELECT *
	INTO smsdss.c_covid_miscref_tbl
	FROM @MiscRef;
