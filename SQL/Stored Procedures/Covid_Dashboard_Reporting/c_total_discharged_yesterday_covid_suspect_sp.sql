USE [SMSPHDSSS0X0]
GO
/****** Object:  StoredProcedure [dbo].[c_total_discharged_yesterday_covid_suspect_sp]    Script Date: 12/21/2020 8:58:08 AM ******/
SET ANSI_NULLS ON
GO
...
***********************************************************************
*/
ALTER PROCEDURE [dbo].[c_total_discharged_yesterday_covid_suspect_sp]
AS
SET ANSI_NULLS ON
