/*
=======================================================================
Get the initial patient population for COPD
=======================================================================
*/
...
/*
=======================================================================
ED Utilization where COPD is listed as the principal diagnosis
=======================================================================
*/
...
WITH CTE3 AS (
	...
	WHERE (
			-- COPD
			-- icd-9 codes
			A.prin_dx_cd BETWEEN '491.0' AND '491.22'
			OR 
			a.prin_dx_cd BETWEEN '493.20' AND '493.22'
			OR 
			A.prin_dx_cd ='496'
			-- icd-10 codes
			OR a.prin_dx_cd IN (
...
, IPC.Admit_Count         AS [Total COPD Inpatient Count]
