...
WITH CTE AS (
	...
	WHERE (
			(   -- icd-9 codes
				...
				OR 
				A.dx_cd BETWEEN '493.20' AND '493.22'
				OR 
				A.dx_cd ='496'
				-- icd-10 codes
				OR A.dx_cd IN (
	...
	AND A.dx_eff_dtime <  '2016-01-01 00:00:00.000'
...
WITH CTE3 AS (
	...
	WHERE (
			(
			   -- icd-9 codes
				...
				OR 
				B.dx_cd BETWEEN '493.20' AND '493.22'
				OR 
				B.dx_cd ='496'
				-- icd-10 codes
				OR B.dx_cd IN (
	...
	AND B.dx_eff_dtime <  '2016-01-01 00:00:00.000'
