/*
=======================================================================
Get the initial patient population for AMI
=======================================================================
*/
...
/*
=======================================================================
ED Utilization where AMI is listed as the principal diagnosis
=======================================================================
*/
...
, CED.[ED AMI Visit Count]
, (
   ERTOT.[Total Count] -
   CED.[ED AMI Visit Count]
  )                       AS [Non AMI ER Visits]
, ERTOT.[Total Count]     AS [Total ER Visits]
, IPC.Admit_Count         AS [Total AMI Inpatient Count]
