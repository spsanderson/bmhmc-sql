coded_consults_query <- function(.resp_party) {
...
coded_consults_top_providers <- function(.data, .top_n, .attending_col, .consultant_col) {
...
coded_consults_seasonal_diagnositcs <- function(
                                                .data,
                                                .date_col,
                                                .value_col) {
...
dump(
  list = function_names,
  file = "S:/Global Finance/1 REVENUE CYCLE/Steve Sanderson II/Code/R/Functions/OPPE_Consultant_Report/oppe_consultant_report_functions.R"
)
