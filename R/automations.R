...
geocode_discharges_automation <- function() {
  ...
  origAddress <- origAddress %>%
    ...
    dplyr::mutate(PartialAddress = dplyr::case_when(
      ...
      , stringr::str_detect(PartialAddress, "MORCIHES, NY")          ~ "MORICHES, NY, 11955"
      ...
      , stringr::str_detect(PartialAddress, "WHITE RIVER JUNCTION, NY") ~ "HARTFORD, VT, 05001"
      , stringr::str_detect(PartialAddress, "MASTC BEACH, NY")       ~ "MASTIC BEACH, NY, 11951"
      , TRUE ~ PartialAddress
    ))
