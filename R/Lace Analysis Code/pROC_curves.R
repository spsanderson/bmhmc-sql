...
plot.roc(lace$FAILURE, lace$TOTAL.LACE, # data
...
plot.roc(lace$FAILURE, lace$TOTAL.LACE,
         percent=TRUE, 
         add=TRUE, 
...
rocobj <- plot.roc(lace$FAILURE, lace$TOTAL.LACE,
...
rocobj1 <- plot.roc(lace$FAILURE, lace$TOTAL.LACE,
                    main="Statistical comparison", percent=TRUE, 
                    col="#1c61b6")

rocobj2 <- lines.roc(lace$FAILURE, lace$LACE.ER.SCORE, percent=TRUE, 
                     col="#008600")
