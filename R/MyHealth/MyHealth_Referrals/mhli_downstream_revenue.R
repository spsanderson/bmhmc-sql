...
mhli_rad_pvt_tbl <- function(.data) {
...
mhli_rad_facility_provider_count_tbl <- function(.data){
...
mhli_rad_ref_lag <- function(.data) {
...
# DS Summary Tbl ----------------------------------------------------------
mhli_ds_summary_tbl <- function(.data) {
...
mhli_rad_summary_tbl <- function(.data) {
...
mhli_pt_registry_data <- function(.user_input){
...
mhli_pt_rad_data <- function(.user_input){
...
dump(
  list = function_names
  , file = "S:/Global Finance/1 REVENUE CYCLE/Steve Sanderson II/Code/R/MyHealth/MyHealth_Referrals/mhli_downstream_revenue_functions.R"
)
