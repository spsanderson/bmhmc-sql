...
refit_tbl %>%
  ...
  plot_modeltime_forecast(
    .legend_max_width = 25
    , .interactive = interactive
    , .title = "Monthly IP Readmit Rates Forecast 1 Year Out"
  )
