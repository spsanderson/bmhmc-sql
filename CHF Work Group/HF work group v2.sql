...
WITH CTE1 AS (
	...
	-- icd-9 codes
		'402.01', '404.01', '428.0', '428.30', '428.40', '429.4', '402.11',
		'404.03', '428.1', '428.31', '428.41', '997.1', '402.91', '404.91',
		'428.20', '428.32', '428.42', '404.93', '428.21', '428.33', '428.43', 
		'404.11', '428.22', '428.9', '404.13', '428.23',
	-- icd-10 codes
		'I11.0', 'I50.1', 'I50.30', 'I50.40', 'I97.130', 'I13.0', 'I50.20',
		'I50.31', 'I50.41', 'I97.131', 'I13.2', 'I50.21', 'I50.32', 'I50.42',
		'I09.81', 'I50.22', 'I50.33', 'I50.43', 'I50.23'
	)
...
---------------------------------------------------------------------------------------------------
-- DATA GOES INTO "Initial Patient Population v2 - NO DIALYSIS"
SELECT A.*
INTO #ACTIVITY_TBL_2
...
---------------------------------------------------------------------------------------------------
-- DATA GOES INTO "HF FFS Cohort Activity - NO DIALYSIS
