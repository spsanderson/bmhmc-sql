...
CASE
	...
	OR
	CAST(A.STROKE_NUM AS FLOAT)/A.STROKE_DENOM >= 0.8485
	THEN .9999
...
CASE
	...
	OR
	CAST(A.RESP_NUM AS FLOAT)/A.RESP_DENOM >= 0.3750
	THEN .9999
...
CASE
	...
	OR
	CAST(A.PN_NUM AS FLOAT)/A.PN_DENOM >= 0.5244
	THEN .9999
...
CASE
	...
	OR
	CAST(A.SEPT_NUM AS FLOAT)/A.SEPT_DENOM >= 0.8068
	THEN .9999
...
CASE
	...
	OR
	CAST(A.VENT_NUM AS FLOAT)/A.VENT_DENOM >= 0.2759
	THEN .9999
