...
CASE
	...
	THEN -789789
    WHEN CAST(A.STROKE_NUM AS FLOAT)/A.STROKE_DENOM <= 0.6533
	THEN -9999.99999
	WHEN CAST(A.STROKE_NUM AS FLOAT)/A.STROKE_DENOM >= 0.8485
	THEN 9999.99999
...
CASE
	WHEN A.RESP_DENOM = 0
	THEN -789789
    WHEN CAST(A.RESP_NUM AS FLOAT)/A.RESP_DENOM <= 0.2085
	THEN -9999.99999
	WHEN CAST(A.RESP_NUM AS FLOAT)/A.RESP_DENOM >= 0.3750
	THEN 9999.99999
...
CASE
	WHEN A.PN_DENOM = 0
	THEN -789789
    WHEN CAST(A.PN_NUM AS FLOAT)/A.PN_DENOM <= 0.3314
	THEN -9999.99999
	WHEN CAST(A.PN_NUM AS FLOAT)/A.PN_DENOM >= 0.5244
	THEN 9999.99999
...
CASE
	WHEN A.SEPT_DENOM = 0
	THEN -789789
    WHEN CAST(A.SEPT_NUM AS FLOAT)/A.SEPT_DENOM <= 0.5578
	THEN -9999.99999
	WHEN CAST(A.SEPT_NUM AS FLOAT)/A.SEPT_DENOM >= 0.8068
	THEN 9999.99999
...
CASE
	WHEN A.VENT_DENOM = 0
	THEN -789789
    WHEN CAST(A.VENT_NUM AS FLOAT)/A.VENT_DENOM <=0.1325
	THEN -9999.99999
	WHEN CAST(A.VENT_NUM AS FLOAT)/A.VENT_DENOM >= 0.2759
	THEN 9999.99999
...
CASE
	WHEN A.TIA_DENOM = 0
	THEN -789789
    WHEN CAST(A.TIA_NUM AS FLOAT)/A.TIA_DENOM >= 0.3721
	THEN 9999.99999
...
CASE
	WHEN A.COPD_DENOM = 0
	THEN -789789
    WHEN CAST(A.COPD_NUM AS FLOAT)/A.COPD_DENOM >= 0.3783
	THEN 9999.99999
...
CASE
	...
	THEN -789789
    WHEN CAST(A.SYNCOPE_NUM AS FLOAT)/A.SYNCOPE_DENOM >= 0.1275
	THEN 9999.99999
...
CASE
	WHEN A.BACK_DENOM = 0
	THEN -789789
    WHEN CAST(A.BACK_NUM AS FLOAT)/A.BACK_DENOM >= 0.3958
	THEN 9999.99999
