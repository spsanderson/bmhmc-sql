...
FROM (
	...
	, COPAY.POSITIVE_PAY AS COPAY_POS_PAY
	, COPAY.NEGATIVE_PAY AS COPAY_NEG_PAY
	, DEDUC.DEDUCTIBLE_FLAG AS DEDUC_FLAG
	, DEDUC.POSITIVE_PAY AS DEDUC_POS_PAY
	, DEDUC.NEGATIVE_PAY AS DEDUC_NEG_PAY
	, COINS.COINSURANCE_FLAG AS COINS_FLAG
	, COINS.POSITIVE_PAY AS COINS_POS_PAY
	, COINS.NEGATIVE_PAY AS COINS_NEG_PAY
...
--where h.pyr_seq_no <> '0'
--and a.pyr_cd <> '*'
--where H.pyr_seq_no = '3' 
--where ZZZ.PtNo_Num = ''
