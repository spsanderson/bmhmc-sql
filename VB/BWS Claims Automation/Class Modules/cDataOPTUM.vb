...
Private Const ModuleName As String = "cDataOPTUM"
...
'Initialize BWS-generated columns (besides Status)
    ...
    '    d("OPTUM_StartTime") = ""
    '    d("OPTUM_ProcessingTime") = ""

    '    d("OPTUM_FileProcessed") = goConfig.InputFileName
...
'Load Status from BDS file
    Status = Trim$(d("OPTUM_Status", True))
...
'Update status values
    ...
    oDataOPTUM.Update_ProcessingTime DateDiff("s", StartProcessingTime, Now())

    'Write to report
    WriteToOutputReport goConfig.ProcessDir & "OPTUM", goConfig.ProcessDir & "OPTUM\" & goConfig.outputFileName

End Sub

Public Sub Update_Status(val As String)
    Status = val
    d("OPTUM_Status") = Status
End Sub

Public Sub AddTo_StatusDetail(val As String)
'StatusDetail = StatusDetail & val
    d("OPTUM_StatusDetail") = val    'StatusDetail
End Sub

Public Sub Update_StartTime(val As Date)
'    StartTime = val
'    d("OPTUM_StartTime") = StartTime
End Sub

Public Sub Update_ProcessingTime(val As Long)
'    ProcessingTime = val
'    d("OPTUM_ProcessingTime") = ProcessingTime
End Sub
