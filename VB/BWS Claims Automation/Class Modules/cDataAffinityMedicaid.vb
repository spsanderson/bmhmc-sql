...
Private Const ModuleName As String = "cDataAffinityMedicaid"
...
'Initialize BWS-generated columns (besides Status)
    ...
    '    d("AFMEDICAID_StartTime") = ""
    '    d("AFMEDICAID_ProcessingTime") = ""

    '    d("AFMEDICAID_FileProcessed") = goConfig.InputFileName
...
'Load Status from BDS file
    Status = Trim$(d("AFMEDICAID_Status", True))
...
'Update status values
    ...
    oDataAffinityMedicaid.Update_ProcessingTime DateDiff("s", StartProcessingTime, Now())

    'Write to report
    WriteToOutputReport goConfig.ProcessDir & "AffinityMedicaid", goConfig.ProcessDir & "AffinityMedicaid\" & goConfig.outputFileName

End Sub

Public Sub Update_Status(val As String)
    Status = val
    d("AFMEDICAID_Status") = Status
End Sub

Public Sub AddTo_StatusDetail(val As String)
'StatusDetail = StatusDetail & val
    d("AFMEDICAID_StatusDetail") = val    'StatusDetail
End Sub

Public Sub Update_StartTime(val As Date)
'    StartTime = val
'    d("AFMEDICAID_StartTime") = StartTime
End Sub

Public Sub Update_ProcessingTime(val As Long)
'    ProcessingTime = val
'    d("AFMEDICAID_ProcessingTime") = ProcessingTime
End Sub
