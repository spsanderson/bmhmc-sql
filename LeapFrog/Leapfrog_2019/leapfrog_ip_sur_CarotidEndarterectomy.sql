...
CROSS APPLY (
	SELECT CASE 
			WHEN SPROC.proc_cd IN ('03CH0Z6', '03CH0ZZ', '03CJ0Z6', '03CJ0ZZ', '03CK0Z6', '03CK0ZZ', '03CL0Z6', '03CL0ZZ', '03CM0Z6', '03CM0ZZ', '03CN0Z6', '03CN0ZZ')
				THEN 'Carotid_Endarterectomy'
			END AS [Surg_Type]
	) [Surgery]
WHERE SPROC.proc_cd IN (
		-- CAROTID ENDARTERECTOMY
		'03CH0Z6', '03CH0ZZ', '03CJ0Z6', '03CJ0ZZ', '03CK0Z6', '03CK0ZZ', '03CL0Z6', '03CL0ZZ', '03CM0Z6', '03CM0ZZ', '03CN0Z6', '03CN0ZZ'
		)
	AND SPROC.pt_id IN (
