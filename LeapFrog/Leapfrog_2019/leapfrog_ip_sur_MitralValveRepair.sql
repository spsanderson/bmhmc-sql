...
CROSS APPLY (
	SELECT CASE 
			WHEN SPROC.proc_cd IN ('027G04Z', '027G0DZ', '027G0ZZ', '02CG0ZZ', '02NG0ZZ', '02QG0ZE', '02QG0ZZ', '02RG07Z', '02RG08Z', '02RG0JZ', '02RG0KZ', '02RG47Z', '02RG48Z', '02RG4JZ', '02RG4KZ', '02UG07E', '02UG07Z', '02UG08E', '02UG08Z', '02UG0JE', '02UG0JZ', '02UG0KE', '02UG0KZ', '02VG0ZZ')
				THEN 'Mitral_Valve_Repair'
			END AS [Surg_Type]
	) [Surgery]
WHERE SPROC.proc_cd IN (
		-- MITRAL VALVE REPAIR
		'027G04Z', '027G0DZ', '027G0ZZ', '02CG0ZZ', '02NG0ZZ', '02QG0ZE', '02QG0ZZ', '02RG07Z', '02RG08Z', '02RG0JZ', '02RG0KZ', '02RG47Z', '02RG48Z', '02RG4JZ', '02RG4KZ', '02UG07E', '02UG07Z', '02UG08E', '02UG08Z', '02UG0JE', '02UG0JZ', '02UG0KE', '02UG0KZ', '02VG0ZZ'
		)
