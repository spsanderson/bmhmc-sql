...
v1		- 10-25-2017	- Initial creation - needs parameterization (hosim_ip_mri_ctscan_var_orders_trending_dynamic.sql)
v2		- 11-07-2017	- Update to only include orders that were entered in 2017 and forward
						- Update the orders in variance query to only bring back those that are inside of the threshold
						  this fits the way the benchmark was created.
...
GROUP BY Ord_Pty_Number, RPT.Ordering_Party, LIHN_Svc_Line, Svc_Sub_Dept_Desc, RPT.Ord_Ent_Mo
